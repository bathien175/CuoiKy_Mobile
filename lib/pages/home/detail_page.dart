...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    String hotelName = widget.hotelData['hotelName'];
    String hotelPrice = widget.hotelData['hotelPrice'];
    String hotelDescription = widget.hotelData['hotelDescrption'];
    String hotelImage = widget.hotelData['hotelImage'];
    String hotelCity = widget.hotelData['hotelCity'];
    // List Image
